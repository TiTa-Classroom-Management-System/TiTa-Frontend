    ...
    return(
        <div className="QuizList_list">
            <div id="QuizList__header" className="row">
                ...
                <div className="col-lg-2"><h5>Quiz Link</h5></div>
                <div className="col-lg-3"><h5>Upload Result</h5></div>
            </div>
            ...
            {(quizzes && quizzes.length>0) ? (quizzes.map((q)=>(
                <div className="QuizList_object row">
                    ...
                    <div className="col-lg-2"><a href = {q.quiz_link} target = "_blank" rel = "noreferrer"><button className = "Quizzes__view-quiz">View Quiz</button></a></div>
                    <div className="col-lg-3"><button value = {q.quiz_id} onClick = {toggleResModal} className = "Quizzes__view-quiz">Upload Result</button></div>
                    ...
                    <Modal isOpen = {resmodal} toggle = {toggleResModal}>
                        ...
                        <ModalBody>
                            <label for = "quiz_res_upload">Choose Result File (.csv)</label>
                            <input 
                                id = "quiz_res_upload"
                                type = "file"
                                accept = ".csv"
