                ...
                <div className = "Assignment_Solved col-11">
                    ...
                    {!loading ? (
                        ...
                        <div className = "Assignment_Solved__header row">
                            <div className = "col-lg-2"><h5>Student ID</h5></div>
                            <div className = "col-lg-3"><h5>Student Name</h5></div>
                            <div className = "col-lg-2"><h5>Submitted at</h5></div>
                            <div className = "col-lg-3"><h5>Submissions</h5></div>
                        </div>
                        {(allass && allass.length > 0) ? (allass.map((a) =>(
                            <div className = "Assignment_Solved__object row">
                                <div className = "col-lg-2">{a.sid}</div>
                                <div className = "col-lg-3">{a.name}</div>
                                <div className = "col-lg-2">{parseDates(a.submitted_at)} {(a.submission_date >= a.submitted_at) ? (<i class="fas fa-clock Assignment_Solved__on-time"></i>) : (<i class="fas fa-clock Assignment_Solved__late"></i>)}</div>
                                <div className = "col-lg-3"><a href = {a.assignment_link} target = "_blank" rel = "noreferrer"><button className = "Assignments__view-assignment">View Submission</button></a></div>
                            </div>
                        ))) : (
