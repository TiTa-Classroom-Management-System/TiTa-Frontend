    ...
    return (
        <div class = "row">
            ...
            <div className="cards-row row">
                ...
                {classroom && Array.isArray(classroom) ? (classroom.length > 0 ? classroom.map((c) => <ShowClassroom classR = {c} /> ) : <p>You have not created any classroom yet...</p>) : <p>Loading classrooms...</p>}
